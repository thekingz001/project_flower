...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://flower-app-8684b.firebaseio.com/"),
    refCart = new Firebase("https://flower-app-8684b.firebaseio.com/cart"),
    refUser = new Firebase("https://flower-app-8684b.firebaseio.com/users"),
    refCategory = new Firebase("https://flower-app-8684b.firebaseio.com/category"),
    refOrder = new Firebase("https://flower-app-8684b.firebaseio.com/orders"),
    refFeatured = new Firebase("https://flower-app-8684b.firebaseio.com/featured"),
    refMenu = new Firebase("https://flower-app-8684b.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
